...
#define BISS_CTLR_INTRFCE_CNT      5
 ...
 */
void biss_service(BISSPorts & biss_ports, BISSConfig & biss_config, interface BISSInterface server i_biss[BISS_CTLR_INTRFCE_CNT]);
